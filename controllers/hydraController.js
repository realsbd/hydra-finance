...
var emailSent = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
module.exports = function (app) {
    ...
    // // Session
        ...
        //loan builder
        app.get('/loanbuilder/preapproval', function(req, res){
            res.render('loanbuilder/preapproval');
        });
        app.post('/loanbuilder/preapproval', urlencodedParser, function(req, res){
            res.render('loanbuilder/preapproval');
        });

        app.get('/loanbuilder/step1', function(req, res){
            res.render('loanbuilder/step1');
        });
        app.post('/loanbuilder/step1', urlencodedParser, function(req, res){
            //var goTo = data.redir('loanbuilder/step2');
            console.log(req.body);
            // data.push(req.body);
            res.render('loanbuilder/step2', {data: req.body});
        });

        app.get('/loanbuilder/step2', function(req, res){
            res.render('loanbuilder/step2');
        });
        app.post('/loanbuilder/step2', urlencodedParser, function(req, res){
            res.render('loanbuilder/step2');
        });

        app.get('/loanbuilder/step3', function(req, res){
            res.render('loanbuilder/step3');
        });
        app.post('/loanbuilder/step3', urlencodedParser, function(req, res){
            res.render('loanbuilder/step3');
        });

        app.get('/loanbuilder/step4', function(req, res){
            res.render('loanbuilder/step4');
        });
        app.post('/loanbuilder/step4', urlencodedParser, function(req, res){
            res.render('loanbuilder/step4');
        });

        app.get('/loanbuilder/step5', function(req, res){
            res.render('loanbuilder/step5');
        });
        app.post('/loanbuilder/step5',urlencodedParser, function(req, res){
            res.render('loanbuilder/step5');
        });

        app.get('/loanbuilder/step6', function(req, res){
            res.render('loanbuilder/step6');
        });
        app.post('/loanbuilder/step6', urlencodedParser, function(req, res){
            res.render('loanbuilder/step6');
        });

        app.get('/loanbuilder/step7', function(req, res){
            res.render('loanbuilder/step7');
        });
        app.post('/loanbuilder/step7', urlencodedParser, function(req, res){
            res.render('loanbuilder/step7');
        });

        app.get('/loanbuilder/step8', function(req, res){
            res.render('loanbuilder/step8');
        });
        app.post('/loanbuilder/step8', urlencodedParser, function(req, res){
            res.render('loanbuilder/step8');
        });

        app.get('/loanbuilder/step9', function(req, res){
            res.render('loanbuilder/step9');
        });
        app.post('/loanbuilder/step9', urlencodedParser, function(req, res){
            res.render('loanbuilder/step9');
        });
